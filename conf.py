...
BLOG_AUTHOR = "NYU Data Services + Data Science Club"  # (translatable)
BLOG_TITLE = "NYU 2021 Love Data Week Datathon"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://nyu-dataservices.github.io/2021-love-datathon/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://nyu-dataservices.github.io/2021-love-datathon/"
BLOG_EMAIL = "data.services@nyu.edu"
BLOG_DESCRIPTION = "The website for the 2021 NYU Love Data Week Datathon."  # (translatable)
...
RSS_COPYRIGHT = 'Contents {license} {date} <a href="mailto:{email}">{author}</a>'
RSS_COPYRIGHT_PLAIN = 'Contents {license} {date} {author}'
